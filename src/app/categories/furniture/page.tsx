...
export default async function Page() {
  ...
  return (
    <div className="grid grid-rows-[auto_1fr_auto] min-h-screen p-8 pb-20 gap-8 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <h1 className="text-3xl font-bold text-center">Furniture Products</h1>
      <p className="text-lg text-gray-600 text-center">Explore our range of furniture products</p>
